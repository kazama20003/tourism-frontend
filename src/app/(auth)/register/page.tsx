        ...
        <div className="relative z-10 flex flex-col justify-between w-full px-12 py-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <h2 className="text-4xl text-white mb-6 leading-tight">
              Join thousands of travelers planning their perfect journey.
            </h2>
            <p className="text-white/90 text-lg leading-relaxed">
              Create your E-tourims account today and unlock access to exclusive travel deals, personalized itineraries,
              and seamless booking management across all your transportation and accommodation needs.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="terms" className="rounded border-border cursor-pointer" />
